...
- Microphone audio and system audio you choose to capture
...
Audio and local Markdown follow the retention days you set in the app. Drive files remain in your Google account until you delete them there.
...
端末内の音声と Markdown は、アプリ設定の保持日数に従います。Drive 上のファイルは、あなたが Google 側で削除するまで残ります。
...
本ポリシーは更新することがあります。更新時は「Last updated」の日付を変更します。
